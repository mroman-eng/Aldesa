...
#"Ejecuta todo lo que en Dataform tenga el tag 'prps_bronze'". 
#Por lo tanto, el tag en el SQLX debe coincidir exactamente con este tag:
DATAFORM_TAGS          = ["prps_bronze"]
...
with DAG(
    ...
    trigger_silver = TriggerDagRunOperator(
        ...
        trigger_dag_id='dag_silver_prps', # Ajustar al nombre real de tu DAG de Silver
        conf={
    ...
    #log_invocation_end_task >> log_trigger_silver_task >> trigger_silver >> log_trigger_silver_end_task  --> descomentar
    log_invocation_end_task >> success_log  #--> borrar
    
    # Bloque 4: Cierre de seguridad
    # ÉXITO: Se dispara solo si el paso final del trigger termina bien
    #log_trigger_silver_end_task >> success_log  #--> descomentar
