...
SOURCE_PREFIX    = "raw/sap/proj/to_be_processed/"
PROCESSED_PREFIX = "raw/sap/proj/processed/"
FAILED_PREFIX    = "raw/sap/proj/unprocessed/"

# Configuración de destino en BigQuery
DESTINATION_DATASET = "raw" 
DESTINATION_TABLE   = "proj"       
...
with DAG(
    ...
    def validate_parquet_callable(**context):
        ...
        # Buscamos la entidad PROJ dentro de la lista
        columns_config = {}
    ...
    trigger_bronze = TriggerDagRunOperator(
        ...
        trigger_dag_id='dag_bronze_proj',
        trigger_rule=TriggerRule.ALL_SUCCESS,
