...
locals {
  ...
  composer_scheduler_count            = try(var.composer.scheduler_count, null)
  composer_scheduler_cpu              = try(var.composer.scheduler_cpu, null)
  composer_scheduler_memory_gb        = try(var.composer.scheduler_memory_gb, null)
  composer_scheduler_storage_gb       = try(var.composer.scheduler_storage_gb, null)
  composer_dag_processor_count        = try(var.composer.dag_processor_count, null)
  composer_dag_processor_cpu          = try(var.composer.dag_processor_cpu, null)
  composer_dag_processor_memory_gb    = try(var.composer.dag_processor_memory_gb, null)
  composer_dag_processor_storage_gb   = try(var.composer.dag_processor_storage_gb, null)
  composer_triggerer_count            = try(var.composer.triggerer_count, null)
  composer_triggerer_cpu              = try(var.composer.triggerer_cpu, null)
  composer_triggerer_memory_gb        = try(var.composer.triggerer_memory_gb, null)
  composer_web_server_cpu             = try(var.composer.web_server_cpu, null)
  composer_web_server_memory_gb       = try(var.composer.web_server_memory_gb, null)
  composer_web_server_storage_gb      = try(var.composer.web_server_storage_gb, null)
  composer_worker_cpu                 = try(var.composer.worker_cpu, null)
  composer_worker_memory_gb           = try(var.composer.worker_memory_gb, null)
  composer_worker_storage_gb          = try(var.composer.worker_storage_gb, null)
